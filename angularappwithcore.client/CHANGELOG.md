...
- Create Angular project with ng: `ng new angularappwithcore.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angularappwithcore.client.esproj`).
